...
const Header = (props: any) => {
  ...
  <div className="header">
    ...
    {loader > 8 && <div><strong>Covid-19:</strong> {covid19.Global.NewConfirmed && <span><strong>New confirmed: </strong>{covid19.Global.NewConfirmed}, <strong>New deaths: </strong>{covid19.Global.NewDeaths}, <strong>Total confirmed: </strong>{covid19.Global.TotalConfirmed}, <strong>Total deaths: </strong>{covid19.Global.TotalDeaths}</span>}</div>}
    <div className="line" />
    <div className="line">
